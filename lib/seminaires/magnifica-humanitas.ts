...
const M1: SeminaireModule = {
  ...
  resume:
    "Magnifica Humanitas affirme que l'humanité se trouve devant un choix décisif. Elle peut bâtir une nouvelle Babel, c'est-à-dire un monde technique dominé par l'orgueil, la puissance, l'uniformisation, l'efficacité sans humanité et l'exclusion des plus faibles. Elle peut aussi choisir la voie de Jérusalem, représentée par Néhémie : reconstruire ensemble une cité plus juste, plus fraternelle et plus humaine.\n\nLe texte ne rejette pas la technique. Il reconnaît qu'elle peut soigner, relier, éduquer et protéger. Mais il rappelle qu'elle peut aussi diviser, manipuler, exclure, surveiller et déshumaniser. L'IA doit donc être évaluée à partir de la dignité humaine, du bien commun, de la justice sociale, de la vérité, de la liberté et de la paix.",
  centralMessage:
    "L'IA doit rester un outil au service de la personne humaine ; elle ne doit jamais devenir un pouvoir qui décide à la place de l'homme ou qui redéfinit la valeur de l'homme.",
  retain: [
