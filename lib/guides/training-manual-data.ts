...
export const TRAINING_SYLLABUS: ManuelSyllabus = {
  ...
  competencesVisees: {
    savoirs: [
      "Connaître l'architecture fonctionnelle d'EduWeb Planner (41 modules, 16 rôles, organisation multi-pays).",
